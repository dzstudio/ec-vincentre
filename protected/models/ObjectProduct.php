...
/**
 * This is the model class for table "object_product".
 *
 * The followings are the available columns in table 'object_product':
 * @property string $id
 ...
 */
class ObjectProduct extends CActiveRecord
{
	/**
	 ...
	 * @return ObjectProduct the static model class
	 */
